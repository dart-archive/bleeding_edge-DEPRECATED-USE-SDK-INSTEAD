...
class SlowBuffer implements Buffer native '*SlowBuffer' {
  ...
  void forEach(void f(int element)) => _forEach(this, f);
  Buffer filter(bool f(int element))
    => _filter(this, f, (length) => new Buffer(length));
  bool every(bool f(int element)) => _every(this, f);
  bool some(bool f(int element)) => _some(this, f);
  bool isEmpty() => _isEmpty(this);
