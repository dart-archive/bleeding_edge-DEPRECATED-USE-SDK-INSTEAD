...
class Server native "require('http').Server" {
  ...
  List<ServerRequestListener> listenersRequest()
    => new _NativeListPrimitiveElement<ServerRequestListener>(
      _listeners('request'));
  ...
  List<ServerCheckContinueListener> listenersCheckContinue()
    => new _NativeListPrimitiveElement<ServerCheckContinueListener>(
  ...
  List<ServerUpgradeListener> listenersUpgrade()
    => new _NativeListPrimitiveElement<ServerUpgradeListener>(
      _listeners('upgrade'));
  ...
  List<ServerClientErrorListener> listenersClientError()
    => new _NativeListPrimitiveElement<ServerClientErrorListener>(
...
class ServerRequest implements EventEmitter native
  ...
  List<ServerRequestDataListener> listenersData()
    => new _NativeListPrimitiveElement<ServerRequestDataListener>(
      _listeners('data'));
  ...
  List<ServerRequestEndListener> listenersEnd()
    => new _NativeListPrimitiveElement<ServerRequestEndListener>(
      _listeners('end'));
  ...
  List<ServerRequestCloseListener> listenersClose()
    => new _NativeListPrimitiveElement<ServerRequestCloseListener>(
      _listeners('close'));
  
  final String method;
  final String url;
  Map<String, String> get headers()
    => new _NativeMapPrimitiveValue<String>(_headers());
...
class ServerResponse implements WritableStream native "http.ServerResponse" {
  // EventEmitter
  void removeAllListeners(String event)
    native "this._writeStream.removeAllListeners(event);";
  ...
  List<StreamErrorListener> listenersError()
    => new _NativeListPrimitiveElement<StreamErrorListener>(_listeners(
        'error'));
  ...
  List<StreamCloseListener> listenersClose()
    => new _NativeListPrimitiveElement<StreamCloseListener>(_listeners(
        'close'));
  ...
  List<WritableStreamDrainListener> listenersDrain()
    => new _NativeListPrimitiveElement<WritableStreamDrainListener>(_listeners(
        'drain'));
  ...
  List<WritableStreamPipeListener> listenersPipe()
    => new _NativeListPrimitiveElement<WritableStreamPipeListener>(_listeners(
        'pipe'));
...
class ClientRequest implements WritableStream native
  ...
  List<ClientRequestResponseListener> listenersResponse()
    => new _NativeListPrimitiveElement<ClientRequestResponseListener>(
      _listeners('response'));
  ...
  List<ClientRequestSocketListener> listenersSocket()
    => new _NativeListPrimitiveElement<ClientRequestSocketListener>(
      _listeners('socket'));
  ...
  List<ClientRequestUpgradeListener> listenersUpgrade()
    => new _NativeListPrimitiveElement<ClientRequestUpgradeListener>(
      _listeners('upgrade'));
  ...
  List<ClientRequestContinueListener> listenersContinue()
    => new _NativeListPrimitiveElement<ClientRequestContinueListener>(
      _listeners('continue'));
...
class ClientResponse implements ReadableStream native
  ...
  List<ReadableStreamDataListener> listenerData()
    => new _NativeListPrimitiveElement<ReadableStreamDataListener>(_listeners(
        'data'));
  ...
  List<ReadableStreamEndListener> listenersEnd()
    => new _NativeListPrimitiveElement<ReadableStreamEndListener>(_listeners(
        'end'));
  ...
  Map<String, String> trailers()
      => new _NativeMapPrimitiveValue<String>(_trailers());
