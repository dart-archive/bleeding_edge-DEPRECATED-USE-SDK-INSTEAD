...
main() {
  ...
  Expect.equals(false, await futureOf(true) && await futureOf(false));
  Expect.equals(false, await futureOf(false) && await futureOf(false));
  Expect.equals(false, await futureOf(false) && await futureOf(true));
  ...
  // altogether.
  Expect.equals(false, await futureOf(false) && await errorOf("ERROR1"));
  Expect.equals(false, await futureOf(false) && await () { throw "ERROR2"; }());
