...
/**
 * An operation for
 * {@link AnalysisServer#searchClassMemberDeclarations(String, SearchResultsConsumer)}.
 * 
 * @coverage dart.server.local
 */
public class SearchClassMemberDeclarationsOperation implements ServerOperation {
  private final String name;
  private final SearchResultsConsumer consumer;

  public SearchClassMemberDeclarationsOperation(String name, SearchResultsConsumer consumer) {
    this.name = name;
