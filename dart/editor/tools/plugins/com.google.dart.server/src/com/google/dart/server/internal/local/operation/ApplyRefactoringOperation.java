...
/**
 * An operation for {@link AnalysisServer#applyRefactoring}.
 * 
 * @coverage dart.server.local
 */
public class ApplyRefactoringOperation implements ServerOperation {
  private final String refactoringId;
  private final RefactoringApplyConsumer consumer;

  public ApplyRefactoringOperation(String refactoringId, RefactoringApplyConsumer consumer) {
...
//    server.internalApplyRefactoring(refactoringId, consumer);
  }
}
