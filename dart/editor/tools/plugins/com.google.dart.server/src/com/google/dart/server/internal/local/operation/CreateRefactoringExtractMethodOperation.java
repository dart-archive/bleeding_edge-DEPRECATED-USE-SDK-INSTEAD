...
/**
 * An operation for {@link AnalysisServer#createRefactoringExtractMethod}.
 * 
 * @coverage dart.server.local
 */
public class CreateRefactoringExtractMethodOperation implements ContextServerOperation {
  private final String contextId;
  private final Source source;
  private final int offset;
  private final int length;
  private final RefactoringExtractMethodConsumer consumer;

  public CreateRefactoringExtractMethodOperation(String contextId, Source source, int offset,
