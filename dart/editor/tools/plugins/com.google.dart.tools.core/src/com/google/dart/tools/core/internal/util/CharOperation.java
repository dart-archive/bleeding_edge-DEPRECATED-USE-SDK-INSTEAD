...
public final class CharOperation {
  ...
  /**
   * Return a new array with appending the suffix character at the end of the array. <br>
   * <br>
   * For example:<br>
   * <ol>
   * <li>
  ...
  /**
   * Return a new array adding the second array at the end of first array. It answers null if the
  ...
  /**
   * Return the concatenation of the two arrays. It answers null if the two arrays are null. If the
  ...
  public static final boolean camelCaseMatch(char[] pattern, int patternStart, int patternEnd,
    ...
    /*
     * !!!!!!!!!! WARNING !!!!!!!!!! The algorithm implemented in this method has been heavily used
     * in StringOperation#getCamelCaseMatchingRegions(String, int, int, String, int, int, boolean)
     * method.
     * 
     * So, if any change needs to be applied in the current algorithm, do NOT forget to also apply
     * the same change in the StringOperation method!
     */
    ...
    while (true) {
      ...
      // For as long as we're exactly matching, bring it on (even if it's a
      // lower case character)
      if ((patternChar = pattern[iPattern]) == name[iName]) {
        continue;
      }

      // If characters are not equals, then it's not a match if patternChar is
      // lowercase
      ...
      while (true) {
        ...
        if (nameChar < ScannerHelper.MAX_OBVIOUS) {
          ...
          if ((charNature & (ScannerHelper.C_LOWER_LETTER | ScannerHelper.C_SPECIAL)) != 0) {
            ...
            // nameChar is digit => break if the digit is current pattern
            // character otherwise consume it
  ...
  /**
   * Return the char arrays as an array of Strings
   * 
  ...
  /**
   * Compares the two char arrays lexicographically. Returns a negative integer if array1
   * lexicographically precedes the array2, a positive integer if this array1 lexicographically
   * follows the array2, or zero if both arrays are equal.
   * 
  ...
  /**
   * Return a new array with prepending the prefix character and appending the suffix character at
  ...
  /**
   * Return the concatenation of the three arrays inserting the sep1 character between the first two
   * arrays and sep2 between the last two. It answers null if the three arrays are null. If the
  ...
  /**
   * Return the concatenation of the three arrays. It answers null if the three arrays are null. If
  ...
  /**
   * Return the concatenation of the given array parts using the given separator between each part. <br>
   * <br>
   * For example:<br>
   * <ol>
   * <li>
  ...
  /**
   * Return true if the array contains an occurrence of character, false otherwise. <br>
   * <br>
   * For example:
   * <ol>
   * <li>
  ...
  /**
   * Return true if the array contains an occurrence of one of the characters, false otherwise. <br>
   * <br>
   * For example:
   * <ol>
   * <li>
  ...
  /**
   * Return true if the two arrays are identical character by character, otherwise false. The
  ...
  /**
   * Return true if the first array is identical character by character to a portion of the second
   ...
   * <code>isCaseSensitive</code> parameter. </p>
   * <p>
   * For example:
   * </p>
   * <ol>
   ...
   * Return true if the name contains the fragment at the starting index startIndex, otherwise
   * false. <br>
   * <br>
   * For example:
   * <ol>
  ...
  public static final int hashCode(char[] array) {
    ...
    if (length < 8) {
      ...
      // 8 characters is enough to compute a decent hash code, don't waste time
  ...
  /**
   * Return the first index in the array for which the corresponding character is equal to toBeFound
   * starting the search at index start. Answers -1 if no occurrence of this character is found. <br>
   * <br>
   * For example:
   * <ol>
   * <li>
  ...
  /**
   * Return the first index in the array for which the corresponding character is equal to toBeFound
   * starting the search at index start and before the ending index. Answers -1 if no occurrence of
  ...
  /**
   * Return true if c is a whitespace according to the JLS (&#92;u000a, &#92;u000c, &#92;u000d,
   * &#92;u0009), otherwise false. <br>
   * <br>
   * For example:
   * <ol>
   * <li>
   ...
   * starting from the end of the array. Answers -1 if no occurrence of this character is found. <br>
   * <br>
   * For example:
   * <ol>
   * <li>
  ...
  /**
   * Return the last index in the array for which the corresponding character is equal to toBeFound
   * starting from endIndex to startIndex. Answers -1 if no occurrence of this character is found. <br>
   * <br>
   * For example:
   * <ol>
   * <li>
  ...
  /**
   * Return the last portion of a name given a separator. <br>
   * <br>
   * For example,
   * 
   * <pre>
  ...
  /**
   * Return the number of occurrences of the given character in the given array, 0 if any. <br>
   * <br>
   * For example:
   * <ol>
   * <li>
  ...
  /**
   * Return the number of occurrences of the given character in the given array starting at the
  ...
  /**
   * Return true if the pattern matches the filepath using the pathSepatator, false otherwise. Path
   * char[] pattern matching, accepting wild-cards '**', '*' and '?' (using Ant directory tasks
   * conventions, also see "http://jakarta.apache.org/ant/manual/dirtasks.html#defaultexcludes").
   * Path pattern matching is enhancing regular pattern matching in supporting extra rule where '**'
   * represent any folder combination. Special rule: - foo\ is equivalent to foo\** When not case
   * sensitive, the pattern is assumed to already be lowercased, the name will be lowercased
   * character per character as comparing.
   * 
   * @param pattern the given pattern
  ...
  /**
   * Return true if the given name starts with the given prefix, false otherwise. The comparison is
   * case sensitive. <br>
   * <br>
   * For example:
   * <ol>
  ...
  /**
   * Return true if the given name starts with the given prefix, false otherwise. isCaseSensitive is
   * used to find out whether or not the comparison should be case sensitive. <br>
   * <br>
   * For example:
   * <ol>
   * <li>
  ...
  /**
   * Return true if the given name, starting from the given index, starts with the given prefix,
  ...
  /**
   * Return a new array removing a given character. Answers the given array if there is no
  ...
  /**
   * Return a new array of characters with substitutions. No side-effect is operated on the original
   * array, in case no substitution happened, then the result is the same as the original one. <br>
   * <br>
   * For example:
   * <ol>
   * <li>
  ...
  /**
   * Return a new array which is a copy of the given array starting at the given start and ending at
   * the given end. The given start is inclusive and the given end is exclusive. Answers null if
  ...
  /**
   * Safely convert the given string to an array of characters.
   * 
   * @param string the string to be converted
   * @return an array of characters that is equivalent to the given string
   */
  ...
  /**
   * Return the result of a char[] conversion to lowercase. Answers null if the given chars array is
   * null. <br>
  ...
  /**
   * Return a string which is the concatenation of the given array using the '.' as a separator. <br>
   * <br>
   * For example:
   * <ol>
   * <li>
  ...
  /**
   * Return an array of strings from the given array of char array.
   * 
   * @param array the given array
  ...
  /**
   * Return the result of a char[] conversion to uppercase. Answers null if the given chars array is
   * null. <br>
   * NOTE: If no conversion was necessary, then answers back the argument one. <br>
   * <br>
   * For example:
  ...
  /**
   * Return a new array removing leading and trailing spaces (' '). Answers the given array if there
   * is no space characters to remove. <br>
   * <br>
   * For example:
   * <ol>
   * <li>
