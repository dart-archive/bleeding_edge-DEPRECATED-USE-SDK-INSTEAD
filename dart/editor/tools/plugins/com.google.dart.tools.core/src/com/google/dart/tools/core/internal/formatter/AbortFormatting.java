...
/**
 * Instances of the class <code>AbortFormatting</code> implement an unchecked exception wrapping
 * invalid input checked exception which may occur when scanning original formatted source.
 */
