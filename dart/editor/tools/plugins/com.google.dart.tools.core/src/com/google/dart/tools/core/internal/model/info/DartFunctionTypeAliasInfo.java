...
/**
 * Instances of the class <code>DartFunctionTypeAliasInfo</code> maintain the cached data shared by
 * all equal function type aliases.
 */
public class DartFunctionTypeAliasInfo extends DeclarationElementInfo {
  /**
