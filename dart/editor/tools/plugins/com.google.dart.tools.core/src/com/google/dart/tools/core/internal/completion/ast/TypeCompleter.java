...
public class TypeCompleter extends DartTypeNode implements CompletionNode {
  ...
  public static TypeCompleter from(DartTypeNode type) {
    return CompletionUtil.init(new TypeCompleter(type.getIdentifier(), type.getTypeArguments()),
        type);
  }

  private Stack<Mark> stack;

  public TypeCompleter(DartNode identifier, List<DartTypeNode> typeArguments) {
