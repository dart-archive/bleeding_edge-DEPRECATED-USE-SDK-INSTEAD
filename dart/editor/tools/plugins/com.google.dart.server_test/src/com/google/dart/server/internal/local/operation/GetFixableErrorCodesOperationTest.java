...
public class GetFixableErrorCodesOperationTest extends TestCase {
  ...
  public void test_perform() throws Exception {
    FixableErrorCodesConsumer consumer = mock(FixableErrorCodesConsumer.class);
    GetFixableErrorCodesOperation operation = new GetFixableErrorCodesOperation("id", consumer);
