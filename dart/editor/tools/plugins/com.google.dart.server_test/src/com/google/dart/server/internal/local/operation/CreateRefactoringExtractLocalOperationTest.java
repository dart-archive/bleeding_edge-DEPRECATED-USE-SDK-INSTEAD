...
public class CreateRefactoringExtractLocalOperationTest extends TestCase {
  ...
  public void test_perform() throws Exception {
    RefactoringExtractLocalConsumer consumer = mock(RefactoringExtractLocalConsumer.class);
    CreateRefactoringExtractLocalOperation operation = new CreateRefactoringExtractLocalOperation(
        "id",
        source,
        42,
        0,
    ...
    verify(server, times(1)).internalCreateRefactoringExtractLocal("id", source, 42, 0, consumer);
  }
}
