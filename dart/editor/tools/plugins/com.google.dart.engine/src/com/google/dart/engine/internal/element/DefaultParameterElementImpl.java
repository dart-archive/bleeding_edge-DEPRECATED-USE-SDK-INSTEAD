...
/**
 * Instances of the class {@code DefaultParameterElementImpl} implement a {@code ParameterElement}
 * for parameters that have an initializer.
 * 
 * @coverage dart.engine.element
 */
public class DefaultParameterElementImpl extends ParameterElementImpl {
  /**
   ...
   */
  public DefaultParameterElementImpl(Identifier name) {
    super(name);
  }
