 ...
 */
public class DelegatingAnalysisContextImpl2 extends AnalysisContextImpl2 {
  /**
   ...
   */
  public DelegatingAnalysisContextImpl2() {
    super();
  }
...
//  }
  ...
  public void setSourceFactory(SourceFactory factory) {
    ...
    if (sdk != null) {
      ...
      if (sdkAnalysisContext instanceof DelegatingAnalysisContextImpl2) {
