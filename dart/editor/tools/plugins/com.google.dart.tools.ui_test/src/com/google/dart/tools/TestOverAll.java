...
/**
 * Build Bot uses this as an ertrypoint to runthe tests.
 *
 * Important note: All tests that are run by this suite must be 
...
public class TestOverAll {
  public static Test suite() {
    ...
    suite.addTest(com.google.dart.indexer.TestAll.suite());
