...
public class StructureSelectPreviousActionTest extends StructureSelectionActionTest {
  ...
  StructureSelectionAction makeAction(CompilationUnitEditor editor, SelectionHistory history) {
    return new StructureSelectPreviousAction(editor, history) {
      @Override
