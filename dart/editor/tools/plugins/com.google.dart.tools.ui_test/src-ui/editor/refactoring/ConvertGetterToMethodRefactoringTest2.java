 ...
 */
public final class ConvertGetterToMethodRefactoringTest2 extends AbstractDartEditorTabTest2 {
  public void test_ok() throws Exception {
    ...
    Shell shell = waitForShell("Convert getter to method");
    {
  ...
  private void selectAndRun(String pattern) throws Exception {
    selectRange(pattern);
    // run action
    IAction action = getEditorAction(DartActionConstants.CONVERT_GETTER_TO_METHOD);
