 ...
 */
public final class ProjectContentSettingsPropertyPage extends ContentSettingsPropertyPage implements
    ...
    switch (type) {
      ...
      default:
        Logger.log(Logger.WARNING,
            "ProjectContentSettingsPropertyPage is instantiated by resource except PROJECT");//$NON-NLS-1$
        break;
    }
    ...
    switch (index) {
      ...
      default:
        Logger.log(Logger.ERROR,
            "Index is out of range in putSelectedPropertyInto() in class ProjectContentSettingsPropertyPage");//$NON-NLS-1$
        break;
    }
  ...
  protected void deleteNoneProperty(int index) {
    switch (index) {
      ...
      default:
        Logger.log(Logger.ERROR,
            "Index is out of range in deleteNoneProperty() in class ProjectContentSettingsPropertyPage");//$NON-NLS-1$
        break;
    }
  }
