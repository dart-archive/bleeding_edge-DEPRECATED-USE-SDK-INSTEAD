...
public final class AnalysisContextFactory {
   ...
   */
  public static AnalysisContextImpl2 context2WithCore() {
    AnalysisContextImpl2 sdkContext = (AnalysisContextImpl2) DirectoryBasedDartSdk.getDefaultSdk2().getContext();
