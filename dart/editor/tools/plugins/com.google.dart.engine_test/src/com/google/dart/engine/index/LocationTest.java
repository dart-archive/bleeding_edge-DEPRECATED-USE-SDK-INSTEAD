...
public class LocationTest extends EngineTestCase {
  public void test_new() throws Exception {
    ...
    // test Location
    Location location = new Location(elementLocation, 1, 2, null);
    assertSame(elementLocation, location.getElementLocation());
  ...
  public void test_new_withPrefix() throws Exception {
    ...
    when(elementLocation.toString()).thenReturn("myElement");
    // test Location
    Location location = new Location(elementLocation, 1, 2, "pref");
    assertSame(elementLocation, location.getElementLocation());
    assertEquals(1, location.getOffset());
    assertEquals(2, location.getLength());
