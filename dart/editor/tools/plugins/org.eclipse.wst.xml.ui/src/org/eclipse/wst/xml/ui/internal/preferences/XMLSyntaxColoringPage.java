 ...
 */
public final class XMLSyntaxColoringPage extends AbstractSyntaxColoringPage implements
   ...
   * 
   * @see
   * org.eclipse.wst.sse.ui.internal.preferences.ui.AbstractSyntaxColoringPage#getSourcePreview()
   */
  ...
  private void initStyleToDescriptionMap() {
    ...
    fStyleToDescriptionMap.put(IStyleConstantsXML.DOCTYPE_EXTERNAL_ID_PUBREF,
        XMLUIMessages.DOCTYPE_Public_Reference_UI_);
    fStyleToDescriptionMap.put(IStyleConstantsXML.DOCTYPE_EXTERNAL_ID_SYSREF,
