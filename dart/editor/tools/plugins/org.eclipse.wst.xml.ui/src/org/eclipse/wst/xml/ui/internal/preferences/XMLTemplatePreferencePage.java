...
public class XMLTemplatePreferencePage extends TemplatePreferencePage {
  ...
  class XMLEditTemplateDialog extends EditTemplateDialog {
    public XMLEditTemplateDialog(Shell parent, Template template, boolean edit,
  ...
  protected Control createContents(Composite ancestor) {
    ...
    PlatformUI.getWorkbench().getHelpSystem().setHelp(c,
        IHelpContextIds.XML_PREFWEBX_TEMPLATES_HELPID);
    return c;
  }
  ...
  protected Template editTemplate(Template template, boolean edit, boolean isNameModifiable) {
    EditTemplateDialog dialog = new XMLEditTemplateDialog(getShell(), template, edit,
