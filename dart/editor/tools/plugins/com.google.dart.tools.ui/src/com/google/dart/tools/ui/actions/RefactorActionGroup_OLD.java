 ...
 */
public class RefactorActionGroup_OLD extends ActionGroup {
...
//  private SelectionDispatchAction fSelfEncapsulateField;
   ...
   */
  public RefactorActionGroup_OLD(DartEditor editor, String groupName) {
    ...
    fRenameAction = new RenameAction_OLD(editor);
    initUpdatingAction(
        fRenameAction,
        provider,
        null,
...
//    editor.setAction("UseSupertype", fUseSupertypeAction); //$NON-NLS-1$
    ...
    fConvertMethodToGetterAction = new ConvertMethodToGetterAction_OLD(editor);
    initUpdatingAction(
    ...
    initUpdatingAction(
        ...
        null,
        selection,
        DartEditorActionDefinitionIds.CONVERT_GETTER_TO_METHOD);
    editor.setAction("ConvertGetterToMethod", fConvertGetterToMethodAction); //$NON-NLS-1$
   ...
   */
  public RefactorActionGroup_OLD(IViewPart part) {
   ...
   */
  public RefactorActionGroup_OLD(IWorkbenchSite site, ISelectionProvider selectionProvider) {
    ...
    fRenameAction = new RenameAction_OLD(fSite);
    initUpdatingAction(
        fRenameAction,
        fSelectionProvider,
        selectionProvider,
...
//    initUpdatingAction(fConvertAnonymousToNestedAction, fSelectionProvider, selectionProvider, selection, IJavaEditorActionDefinitionIds.CONVERT_ANONYMOUS_TO_NESTED);
    ...
    fConvertMethodToGetterAction = new ConvertMethodToGetterAction_OLD(fSite);
    initUpdatingAction(
        fConvertMethodToGetterAction,
        fSelectionProvider,
        selectionProvider,
...
//    initUpdatingAction(fIntroduceIndirectionAction, fSelectionProvider, selectionProvider, selection, IJavaEditorActionDefinitionIds.INTRODUCE_INDIRECTION);
   ...
   */
  public RefactorActionGroup_OLD(Page page) {
...
//    disposeAction(fIntroduceIndirectionAction, fSelectionProvider);
    ...
    disposeAction(fConvertGetterToMethodAction, fSelectionProvider);
...
//    added += addAction(refactorSubmenu, fRenameAction);
    ...
    added += addAction(refactorSubmenu, GROUP_REORG, fConvertGetterToMethodAction);
