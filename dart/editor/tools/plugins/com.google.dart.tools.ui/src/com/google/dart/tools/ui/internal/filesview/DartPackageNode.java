 ...
 */
public class DartPackageNode implements IDartNode {

  private InstalledPackagesNode parent;
  private String name;
  private String version;
  private String location;
  private IFileStore root;

  public DartPackageNode(InstalledPackagesNode parent, String name, String version, String location) {
    this.parent = parent;
    this.name = name;
