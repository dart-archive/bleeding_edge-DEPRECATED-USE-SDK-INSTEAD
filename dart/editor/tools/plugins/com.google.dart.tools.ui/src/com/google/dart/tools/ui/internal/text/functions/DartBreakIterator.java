 ...
 * </p>
 */
public class DartBreakIterator extends BreakIterator {
  ...
  static final class CamelCaseIdentifier extends Run {
    ...
    /*
     * @see com.google.dart.tools.ui.functions.JavaBreakIterator.Run#consumes(char)
     */
    @Override
    protected boolean consume(char ch) {
      int kind = getKind(ch);
    ...
    /*
     * @see com.google.dart.tools.ui.functions.JavaBreakIterator.Run#isValid(char)
     */
    @Override
  ...
  static final class LineDelimiter extends Run {
    ...
    /*
     * @see com.google.dart.tools.ui.functions.JavaBreakIterator.Run#consume(char)
     */
    @Override
    protected boolean consume(char ch) {
