...
import com.google.dart.tools.ui.internal.viewsupport.SourcePositionComparator_OLD;
 ...
 */
public class DartOutlinePage_OLD extends Page implements IContentOutlinePage, IAdaptable,
    IPostSelectionProvider, DartOutlinePage_I {
...
//            updateItem(item, affectedElement);
  ...
  class LexicalSortingAction extends Action {
    ...
    private final SourcePositionComparator_OLD fSourcePositonComparator = new SourcePositionComparator_OLD();
...
//  private CategoryFilterActionGroup fCategoryFilterActionGroup;
  ...
  public DartOutlinePage_OLD(String contextMenuID, DartEditor editor) {
    super();
...
//            | DartElementLabels.ALL_CATEGORY, AppearanceAwareLabelProvider.DEFAULT_IMAGEFLAGS);
    ...
    fActionGroups = new CompositeActionGroup(new ActionGroup[] {
        new OpenViewActionGroup_OLD(this), new RefactorActionGroup_OLD(this),
