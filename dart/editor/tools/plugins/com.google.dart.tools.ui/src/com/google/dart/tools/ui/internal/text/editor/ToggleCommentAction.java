...
public final class ToggleCommentAction extends TextEditorAction {
  ...
  public void run() {
    ...
    if (!fOperationTarget.canDoOperation(operationCode)) {
      if (shell != null) {
        MessageDialog.openError(shell, DartEditorMessages.ToggleComment_error_title,
            DartEditorMessages.ToggleComment_error_message);
      }
      return;
    }
  ...
  public void update() {
    ...
    boolean isEnabled = (fOperationTarget != null
        && fOperationTarget.canDoOperation(ITextOperationTarget.PREFIX) && fOperationTarget.canDoOperation(ITextOperationTarget.STRIP_PREFIX));
