...
public class BasicElementLabels {
  ...
  /**
   * Returns a label for an element name. Example is 'new Test<? extends List>() { ...}'. This
   * method should only be used for simple element names. Use DartElementLabels to create a label
   * from a Dart element.
   * 
