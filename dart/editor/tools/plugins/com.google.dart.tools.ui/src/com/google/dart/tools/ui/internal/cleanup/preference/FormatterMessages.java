...
final class FormatterMessages extends NLS {
  ...
  public static String CommentsTabPage_new_lines_at_dartdoc_boundaries;
  ...
  public static String commentsTabPage_enable_dartdoc_comment_formatting;
  ...
  public static String CommentsTabPage_blank_line_before_dartdoc_tags;
  public static String CommentsTabPage_indent_dartdoc_tags;
  ...
  public static String ProfileManager_dart_conventions_profile_name;
  public static String DartPreview_formatter_exception;

  public static String WhiteSpaceTabPage_sort_by_dart_element;
