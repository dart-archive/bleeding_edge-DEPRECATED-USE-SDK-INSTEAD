 ...
 */
public class OpenViewActionGroup_OLD extends ActionGroup {
...
//	private OpenAttachedJavadocAction fOpenAttachedJavadoc;
  private OpenTypeHierarchyAction_OLD fOpenTypeHierarchy;
...
//  private boolean fShowShowInMenu = true;
   ...
   */
  public OpenViewActionGroup_OLD(DartEditor part) {
    fEditorIsOwner = true;
...
//		part.setAction("OpenAttachedJavadoc", fOpenAttachedJavadoc); //$NON-NLS-1$
    ...
    fOpenTypeHierarchy = new OpenTypeHierarchyAction_OLD(part);
   ...
   */
  public OpenViewActionGroup_OLD(IViewPart part) {
    this(part, null);
  }
   ...
   */
  public OpenViewActionGroup_OLD(IViewPart part, ISelectionProvider selectionProvider) {
   ...
   * @param selectionProvider the selection provider used instead of the page selection provider.
   */
  public OpenViewActionGroup_OLD(IWorkbenchSite site, ISelectionProvider selectionProvider) {
   ...
   */
  public OpenViewActionGroup_OLD(Page page) {
   ...
   * @param selectionProvider the selection provider used instead of the page selection provider.
   */
  public OpenViewActionGroup_OLD(Page page, ISelectionProvider selectionProvider) {
...
//		fOpenAttachedJavadoc.setSpecialSelectionProvider(specialProvider);
    ...
    fOpenTypeHierarchy = new OpenTypeHierarchyAction_OLD(site);
    fOpenTypeHierarchy.setActionDefinitionId(DartEditorActionDefinitionIds.OPEN_TYPE_HIERARCHY);
    fOpenTypeHierarchy.setId(DartEditorActionDefinitionIds.OPEN_TYPE_HIERARCHY);
