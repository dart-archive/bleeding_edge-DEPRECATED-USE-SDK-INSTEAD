...
// TODO (pquitslund): implement codegen util methods as-needed  
//  /**
//   * Constant ID for the type kind to be used in
//   * {@link #getTypeBody(String, CompilationUnit, String, String)} to get the
...
//
//  /**
//   * Returns the content for a new compilation unit using the 'new JavaScript
//   * file' code template.
//   * 
//   * @param cu The compilation unit to create the source for. The compilation
//   *          unit does not need to exist.
//   * @param typeComment The comment for the type to be created. Used when the
//   *          code template contains a <i>${typecomment}</i> variable. Can be
...
//   *           fails.
//   */
//  public static String getCompilationUnitContent(CompilationUnit cu,
//      String typeComment, String typeContent, String lineDelimiter)
//      throws CoreException {
//    return getCompilationUnitContent(cu, getFileComment(cu, lineDelimiter),
...
//    return StubUtility.getCompilationUnitContent(cu, fileComment, typeComment,
...
//   *           fails.
//   */
//  public static String getFieldComment(CompilationUnit cu, String typeName,
...
//   * template. The returned content is unformatted and is not indented.
//   * 
//   * @param cu The compilation unit to add the comment to. The compilation unit
...
//   *           fails.
//   */
//  public static String getFileComment(CompilationUnit cu, String lineDelimiter)
//      throws CoreException {
...
//   *           fails.
//   */
//  public static String getGetterComment(CompilationUnit cu,
...
//   *           fails.
//   */
//  public static String getGetterMethodBodyContent(CompilationUnit cu,
//      String declaringTypeName, String methodName, String fieldName,
//      String lineDelimiter) throws CoreException {
//    return StubUtility.getGetterMethodBodyContent(cu.getDartProject(),
...
//  }
  ...
  public static String getMethodBodyContent(CompilationUnit cu, String declaringTypeName,
      ...
      throws CoreException {
    return StubUtility.getMethodBodyContent(isConstructor, cu.getDartProject(), declaringTypeName,
...
//   *          {@link org.eclipse.wst.jsdt.core.dom.AST#newFunctionDeclaration()}
//   *          for how to create such a node.
//   * @param isDeprecated If set, the method is deprecated
//   * @param overriddenMethodName If a method is overridden, the simple name of
//   *          the overridden method, or <code>null</code> if no method is
//   *          overridden.
//   * @param overriddenMethodDeclaringTypeName If a method is overridden, the
//   *          fully qualified type name of the overridden method's declaring
//   *          type, or <code>null</code> if no method is overridden.
//   * @param overriddenMethodParameterTypeNames If a method is overridden, the
//   *          fully qualified parameter type names of the overridden method, or
//   *          <code>null</code> if no method is overridden.
//   * @param lineDelimiter The line delimiter to be used.
...
//   */
//
//  public static String getMethodComment(CompilationUnit cu,
//      String declaringTypeName, FunctionDeclaration decl, boolean isDeprecated,
//      String overriddenMethodName, String overriddenMethodDeclaringTypeName,
//      String[] overriddenMethodParameterTypeNames, String lineDelimiter)
//      throws CoreException {
...
//   *          {@link org.eclipse.wst.jsdt.core.dom.AST#newFunctionDeclaration()}
//   *          for how to create such a node.
//   * @param overridden The binding of the method to which to add an "@see" link
//   *          or <code>null</code> if no link should be created.
//   * @param lineDelimiter The line delimiter to be used.
...
//   */
//  public static String getMethodComment(CompilationUnit cu,
//      String declaringTypeName, FunctionDeclaration decl,
//      IFunctionBinding overridden, String lineDelimiter) throws CoreException {
//    if (overridden != null) {
...
//      return StubUtility.getMethodComment(cu, declaringTypeName, decl,
//          overridden.isDeprecated(), linkToMethodName,
//          declaringClassQualifiedName, parameterTypesQualifiedNames, false,
//          lineDelimiter);
//    } else {
//      return StubUtility.getMethodComment(cu, declaringTypeName, decl, false,
//          null, null, null, false, lineDelimiter);
//    }
//  }
   ...
   * <code>{"QString;","I"}</code> as parameter types. See
   * {@link org.eclipse.wst.jsdt.core.Signature}.
   * 
   * @param cu The compilation unit to which the method belongs. The compilation unit does not need
   *          to exist.
   * @param declaringTypeName Name of the type to which the method belongs. For inner types the name
  ...
  public static String getMethodComment(CompilationUnit cu, String declaringTypeName,
      ...
      String lineDelimiter) throws CoreException {
    return StubUtility.getMethodComment(cu, declaringTypeName, methodName, paramNames, excTypeSig,
        retTypeSig, false, lineDelimiter);
  }
