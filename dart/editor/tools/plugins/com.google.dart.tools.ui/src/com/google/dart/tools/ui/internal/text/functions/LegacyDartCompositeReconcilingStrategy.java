...
import com.google.dart.tools.ui.internal.text.dart.LegacyDartReconcilingStrategy;
...
/**
 * Legacy reconciling strategy for Dart code.
 * <p>
 * NOTE: to be replaced by {@link DartCompositeReconcilingStrategy}.
 */
public class LegacyDartCompositeReconcilingStrategy extends CompositeReconcilingStrategy {

  private ITextEditor fEditor;
  private LegacyDartReconcilingStrategy dartStrategy;
   ...
   */
  public LegacyDartCompositeReconcilingStrategy(ISourceViewer viewer, ITextEditor editor,
      String documentPartitioning) {
    fEditor = editor;
    dartStrategy = new LegacyDartReconcilingStrategy(editor);
    DartX.todo("spelling");
