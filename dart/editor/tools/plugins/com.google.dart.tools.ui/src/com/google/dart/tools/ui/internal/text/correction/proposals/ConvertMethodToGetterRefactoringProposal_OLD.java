 ...
 */
public class ConvertMethodToGetterRefactoringProposal_OLD extends AbstractSelectionActionProposal_OLD {
  public ConvertMethodToGetterRefactoringProposal_OLD(ConvertMethodToGetterAction_OLD action,
