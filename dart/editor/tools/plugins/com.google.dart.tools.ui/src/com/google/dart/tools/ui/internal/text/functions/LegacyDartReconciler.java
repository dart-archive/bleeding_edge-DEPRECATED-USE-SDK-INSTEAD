 ...
 * <p>
 * NOTE: to be replaced by the "new world" {@link DartReconciler}.
 */
public class LegacyDartReconciler extends MonoReconciler {
    ...
    public void shellActivated(ShellEvent e) {
      if (!fControl.isDisposed() && fControl.isVisible()) {
        if (hasJavaModelChanged()) {
          LegacyDartReconciler.this.forceReconciling();
        }
   ...
   */
  public LegacyDartReconciler(ITextEditor editor, LegacyDartCompositeReconcilingStrategy strategy,
...
// editor.
  ...
  protected void aboutToBeReconciled() {
    LegacyDartCompositeReconcilingStrategy strategy = (LegacyDartCompositeReconcilingStrategy) getReconcilingStrategy(IDocument.DEFAULT_CONTENT_TYPE);
