...
public interface DartHelpContextIds {
  ...
  /*  */
  public static final String GENERATE_HASHCODE_EQUALS_ACTION = PREFIX
      + "add_hashcode_equals_action_context"; //$NON-NLS-1$
  ...
  public static final String CREATE_NEW_CONSTRUCTOR_ACTION = PREFIX
      + "create_new_constructor_action_context"; //$NON-NLS-1$	
  ...
  public static final String TOGGLE_MARK_OCCURRENCES_ACTION = PREFIX
      + "toggle_mark_occurrences_action_context"; //$NON-NLS-1$
  ...
  /**  */
  public static final String OPEN_ANNOTATION_WIZARD_ACTION = PREFIX
      + "open_annotation_wizard_action"; //$NON-NLS-1$
  ...
  /**  */
  public static final String OPEN_SOURCEFOLDER_WIZARD_ACTION = PREFIX
      + "open_sourcefolder_wizard_action"; //$NON-NLS-1$
  ...
  /**
	 * 
	 */
  public static final String CONFIG_CONTAINER_ACTION = PREFIX
      + "com.google.dart.tools.ui.config_container_action"; //$NON-NLS-1$
  ...
  public static final String FIND_DECLARATIONS_IN_PROJECT_ACTION = PREFIX
      + "find_declarations_in_project_action"; //$NON-NLS-1$	
  ...
  public static final String FIND_IMPLEMENTORS_IN_PROJECT_ACTION = PREFIX
      + "find_implementors_in_project_action"; //$NON-NLS-1$			
  ...
  public static final String FIND_REFERENCES_IN_PROJECT_ACTION = PREFIX
      + "find_references_in_project_action"; //$NON-NLS-1$			
  ...
  public static final String FIND_READ_REFERENCES_IN_PROJECT_ACTION = PREFIX
      + "find_read_references_in_project_action"; //$NON-NLS-1$			
  ...
  public static final String FIND_WRITE_REFERENCES_IN_PROJECT_ACTION = PREFIX
      + "find_write_references_in_project_action"; //$NON-NLS-1$
  ...
  public static final String CONVERT_GETTER_TO_METHOD_ACTION = PREFIX
      + "convertGetterToMethod_action"; //$NON-NLS-1$
  /**
	 * 
	 */
  ...
  // *** Don't delete this constants and the doc since it is still used in
  // refactoring
  ...
  public static final String ADD_GETTER_SETTER_SELECTION_DIALOG = PREFIX
      + "add_getter_setter_selection_dialog_context"; //$NON-NLS-1$
  public static final String ADD_DELEGATE_METHODS_SELECTION_DIALOG = PREFIX
      + "add_delegate_methods_selection_dialog_context"; //$NON-NLS-1$
  public static final String GENERATE_HASHCODE_EQUALS_SELECTION_DIALOG = PREFIX
      + "hash_code_equals_tree_selection_dialog_context"; //$NON-NLS-1$
  public static final String GENERATE_CONSTRUCTOR_USING_FIELDS_SELECTION_DIALOG = PREFIX
      + "generate_constructor_using_fields_selection_dialog_context"; //$NON-NLS-1$
  public static final String ADD_UNIMPLEMENTED_CONSTRUCTORS_DIALOG = PREFIX
      + "add_unimplemented_constructors_dialog_context"; //$NON-NLS-1$
  ...
  public static final String TYPE_FILTER_PREFERENCE_PAGE = PREFIX
      + "type_filter_preference_page_context"; //$NON-NLS-1$
  ...
  /**
	 * 
	 */
  public static final String CP_USERLIBRARIES_PREFERENCE_PAGE = PREFIX
      + "cp_userlibraries_preference_page_context"; //$NON-NLS-1$
  ...
  public static final String JAVADOC_PROBLEMS_PROPERTY_PAGE = PREFIX
      + "javadoc_problems_property_page_context"; //$NON-NLS-1$
  public static final String PROBLEM_SEVERITIES_PROPERTY_PAGE = PREFIX
      + "problem_severities_property_page_context"; //$NON-NLS-1$
  public static final String TODOTASK_PROPERTY_PAGE = PREFIX + "tasktags_property_page_context"; //$NON-NLS-1$

  /**
	 * 
	 */
  public static final String CODE_TEMPLATES_PREFERENCE_PAGE = PREFIX
      + "code_templates_preference_context"; //$NON-NLS-1$
  ...
  public static final String PROPERTIES_FILE_EDITOR_PREFERENCE_PAGE = PREFIX
      + "properties_file_editor_preference_page_context"; //$NON-NLS-1$
  public static final String COMPILER_PREFERENCE_PAGE = PREFIX + "compiler_preference_page_context"; //$NON-NLS-1$
  public static final String JAVA_BUILD_PREFERENCE_PAGE = PREFIX
      + "java_build_preference_page_context"; //$NON-NLS-1$
  public static final String JAVADOC_PROBLEMS_PREFERENCE_PAGE = PREFIX
      + "javadoc_problems_preference_page_context"; //$NON-NLS-1$
  public static final String PROBLEM_SEVERITIES_PREFERENCE_PAGE = PREFIX
      + "problem_severities_preference_page_context"; //$NON-NLS-1$
  ...
  public static final String JAVADOC_CONFIGURATION_PROPERTY_PAGE = PREFIX
      + "javadoc_configuration_property_page_context"; //$NON-NLS-1$
  ...
  // since 3.1
  public static final String NEW_ANNOTATION_WIZARD_PAGE = PREFIX
      + "new_annotation_wizard_page_context"; //$NON-NLS-1$
  ...
  // since 3.2
  public static final String JARPACKAGER_REFACTORING_DIALOG = PREFIX
      + "jar_packager_refactoring_dialog_context"; //$NON-NLS-1$
  // since 3.2
  public static final String JARIMPORT_WIZARD_PAGE = PREFIX + "jar_import_wizard_page_context"; //$NON-NLS-1$
  // since 3.2
  public static final String INCLUSION_EXCLUSION_WIZARD_PAGE = PREFIX
      + "edit_inclusion_exlusion_filter_wizard_page_context"; //$NON-NLS-1$
  ...
  // *** Don't delete this constants and the doc since it is still used in
  // refactoring
  public static final String REFACTORING_ERROR_WIZARD_PAGE = PREFIX
      + "refactoring_error_wizard_page_context"; //$NON-NLS-1$
  ...
  public static final String INTRODUCE_PARAMETER_WIZARD_PAGE = PREFIX
      + "introduce_parameter_page_context"; //$NON-NLS-1$
  public static final String INTRODUCE_FACTORY_WIZARD_PAGE = PREFIX
      + "introduce_factory_wizard_page_context"; //$NON-NLS-1$
  /**
	 * 
	 */
  public static final String INTRODUCE_INDIRECTION_WIZARD_PAGE = PREFIX
      + "introduce_indirection_wizard_page_context"; //$NON-NLS-1$
  ...
  /**
	 * 
	 */
  public static final String EXTRACT_SUPERTYPE_WIZARD_PAGE = PREFIX
      + "extract_supertype_wizard_page_context"; //$NON-NLS-1$
  ...
  public static final String RENAME_TYPE_PARAMETER_WIZARD_PAGE = PREFIX
      + "rename_type_parameter_wizard_page_context"; //$NON-NLS-1$
  public static final String RENAME_LOCAL_VARIABLE_WIZARD_PAGE = PREFIX
  ...
  public static final String RENAME_RESOURCE_WIZARD_PAGE = PREFIX
      + "rename_resource_wizard_page_context"; //$NON-NLS-1$
  public static final String RENAME_JAVA_PROJECT_WIZARD_PAGE = PREFIX
      + "rename_java_project_wizard_page_context"; //$NON-NLS-1$
  public static final String RENAME_SOURCE_FOLDER_WIZARD_PAGE = PREFIX
      + "rename_source_folder_wizard_page_context"; //$NON-NLS-1$
  ...
  public static final String SELECT_CLEAN_UPS_PAGE = PREFIX
      + "select_clean_ups_wizard_page_context"; //$NON-NLS-1$

  public static final String INFER_TYPE_ARGUMENTS_WIZARD_PAGE = PREFIX
      + "infer_type_arguments_wizard_page_context"; //$NON-NLS-1$
  ...
  public static final String CALL_HIERARCHY_FILTERS_DIALOG = PREFIX
      + "call_hierarchy_filters_dialog_context"; //$NON-NLS-1$
  public static final String CALL_HIERARCHY_FOCUS_ON_SELECTION_ACTION = PREFIX
      + "call_hierarchy_focus_on_selection_action_context"; //$NON-NLS-1$
  public static final String CALL_HIERARCHY_HISTORY_ACTION = PREFIX
      + "call_hierarchy_history_action_context"; //$NON-NLS-1$
  public static final String CALL_HIERARCHY_HISTORY_DROP_DOWN_ACTION = PREFIX
      + "call_hierarchy_history_drop_down_action_context"; //$NON-NLS-1$
  public static final String CALL_HIERARCHY_REFRESH_ACTION = PREFIX
      + "call_hierarchy_refresh_action_context"; //$NON-NLS-1$
  public static final String CALL_HIERARCHY_SEARCH_SCOPE_ACTION = PREFIX
      + "call_hierarchy_search_scope_action_context"; //$NON-NLS-1$
  ...
  public static final String CALL_HIERARCHY_COPY_ACTION = PREFIX
      + "call_hierarchy_copy_action_context"; //$NON-NLS-1$
  public static final String CALL_HIERARCHY_TOGGLE_IMPLEMENTORS_ACTION = PREFIX
      + "call_hierarchy_toggle_implementors_action_context"; //$NON-NLS-1$
  public static final String CALL_HIERARCHY_OPEN_ACTION = PREFIX
  ...
  public static final String CODE_STYLE_EDIT_PREFIX_SUFFIX = PREFIX
      + "code_style_edit_prefix_suffix"; //$NON-NLS-1$
  // Code Clean Up Preference Page
  ...
  // Build path
  public static final String BP_CHOOSE_EXISTING_FOLDER_TO_MAKE_SOURCE_FOLDER = PREFIX
      + "bp_choose_existing_folder_to_make_source_folder"; //$NON-NLS-1$
  public static final String BP_CREATE_NEW_FOLDER = PREFIX + "bp_create_new_folder_dialog"; //$NON-NLS-1$
  public static final String BP_SELECT_DEFAULT_OUTPUT_FOLDER_DIALOG = PREFIX
      + "bp_select_default_output_folder_dialog"; //$NON-NLS-1$
  public static final String BP_SELECT_CLASSPATH_CONTAINER = PREFIX
      + "bp_select_classpath_container"; //$NON-NLS-1$
}
