...
public interface IDartRefactorings {
  ...
  /**
   * Refactoring id of the 'Rename Dart Project' refactoring (value:
   * <code>com.google.dart.tools.ui.rename.dart.project</code>).
   * <p>
   * Clients may safely cast the obtained refactoring descriptor to
   * {@link RenameDartElementDescriptor}.
   * </p>
   */
  public static final String RENAME_DART_PROJECT = "com.google.dart.tools.ui.rename.dart.project"; //$NON-NLS-1$
