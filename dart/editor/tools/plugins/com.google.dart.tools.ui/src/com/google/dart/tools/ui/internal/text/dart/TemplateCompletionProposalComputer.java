...
public final class TemplateCompletionProposalComputer implements IDartCompletionProposalComputer {
   ...
   */
  @Override
  public List<TemplateProposal> computeCompletionProposals(ContentAssistInvocationContext context,
    ...
    if (engine != null) {
      ...
      List<TemplateProposal> result = new ArrayList<TemplateProposal>(
