...
import com.google.dart.tools.ui.internal.cleanup.preference.CleanUpProfileVersioner;
...
public class CleanUpConstants {
  ...
  /**
   * Format dartdoc comments. Only has an effect if {@link #FORMAT_COMMENT} is TRUE <br>
   * <br>
   * Possible values: {TRUE, FALSE}<br>
   * <br>
   * 
   ...
   */
  @Deprecated
  public static final String FORMAT_JAVADOC = "cleanup.format_dartdoc"; //$NON-NLS-1$
 ...
 * </pre>
   ...
   *                   }
   * </pre>
   * Only has an effect if {@link #ADD_MISSING_ANNOTATIONS} and
   * {@link #ADD_MISSING_ANNOTATIONS_OVERRIDE} are TRUE and the compiler compliance is 1.6 or
   * higher.<br>
   * <br>
   * Possible values: {TRUE, FALSE}<br>
   * <br>
   ...
   * java.io.Externalizable public class E implements Serializable {} -> public class E implements
   * Serializable { private static final long serialVersionUID = 4381024239L; } <br>
  ...
  /**
   * If true the imports are organized while cleaning up code. Possible values: {TRUE, FALSE}<br>
   * <br>
   * 
   * @see CleanUpOptions#TRUE
   * @see CleanUpOptions#FALSE
  ...
  public static void initDefaults(IPreferenceStore store) {
    CleanUpOptions settings = DartToolsPlugin.getDefault().getCleanUpRegistry().getDefaultOptions(
...
//    options.setOption(UnimplementedCodeCleanUp.MAKE_TYPE_ABSTRACT, CleanUpOptions.FALSE);
    ...
    options.setOption(CLEANUP_ON_SAVE_ADDITIONAL_OPTIONS, CleanUpOptions.TRUE);
  }
