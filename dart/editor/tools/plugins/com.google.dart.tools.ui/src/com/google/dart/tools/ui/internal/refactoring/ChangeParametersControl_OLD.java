...
public class ChangeParametersControl_OLD extends Composite {
  ...
  private class ParametersCellModifier implements ICellModifier {
    ...
    public void modify(Object element, String property, Object value) {
      ...
      if (!unchanged) {
        ChangeParametersControl_OLD.this.fListener.parameterChanged(parameter);
        ChangeParametersControl_OLD.this.fTableViewer.update(parameter, new String[] {property});
      }
    }
  }
  ...
  private final IParameterListChangeListener_OLD fListener;
  ...
  public ChangeParametersControl_OLD(Composite parent, int style, String label,
      IParameterListChangeListener_OLD listener, Mode mode) {
   ...
   */
  public ChangeParametersControl_OLD(Composite parent, int style, String label,
      IParameterListChangeListener_OLD listener, Mode mode, String[] paramNameProposals) {
    super(parent, style);
    ...
    button.addSelectionListener(new SelectionAdapter() {
      ...
      public void widgetSelected(SelectionEvent e) {
        try {
          ...
          ParameterEditDialog_OLD dialog = new ParameterEditDialog_OLD(
              getShell(),
              parameter,
