...
import com.google.dart.tools.search.internal.ui.FindReferencesAction;
...
/**
 * Search for all uses of elements with specified name.
 */
public class WhoUsesElement extends OmniElement {

  /**
   * An executed text search (restored from a memento). Notably, executed searches do not update
   * their search filter text.
   */
  static final class Memento extends WhoUsesElement {
  ...
  public WhoUsesElement(TextSearchProvider provider) {
    super(provider);
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof WhoUsesElement)) {
      return false;
    }
    WhoUsesElement other = (WhoUsesElement) obj;
  ...
  @Override
  public String getId() {
    return getProvider().getId() + ".whoUses." + getSearchText(); //$NON-NLS-1$
  }
  ...
  public String getLabel() {
    ...
    updateSearchText();
    return Messages.format(OmniBoxMessages.WhoUsesElement_label, searchText);
  }
  ...
  public int getMatchTextOffset() {
    return OmniBoxMessages.WhoUsesElement_label.indexOf('{') - 1;
  }
