...
public class CleanLibrariesAction extends Action implements ActionFactory.IWorkbenchAction {
   ...
   */
  public CleanLibrariesAction(IWorkbenchWindow window, boolean fullRebuild) {
    super(fullRebuild ? BuildMessages.CleanLibrariesAction_rebuildAll
        : BuildMessages.CleanLibrariesAction_rebuildLibraries);
