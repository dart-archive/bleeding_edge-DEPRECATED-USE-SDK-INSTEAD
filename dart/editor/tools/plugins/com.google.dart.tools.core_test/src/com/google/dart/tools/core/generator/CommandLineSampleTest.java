...
public class CommandLineSampleTest extends TestCase {
  ...
  public void testGenerateSample() throws Exception {
    ...
    try {
      CommandLineSample generator = new CommandLineSample();

      IFile mainFile = generator.generateInto(project, "foo");

      assertEquals("bin/foo.dart", mainFile.getProjectRelativePath().toPortableString());
