...
public class DeltaProcessorTest extends AbstractDartCoreTest {
  ...
  public void test_traverse_file1Added() throws Exception {
    ...
    DeltaProcessor processor = new DeltaProcessor(project, new ProjectUpdater(project, true));
  ...
  public void test_traverse_folder1a() throws Exception {
    ...
    DeltaProcessor processor = new DeltaProcessor(project, new ProjectUpdater(project, false));
    processor.traverse(web);
  ...
  public void test_traverse_folder2Added() throws Exception {
    ...
    context.assertSourcesAvailable(resources1);
    ...
    context.assertSourcesAvailable(resources2);
   ...
   */
  private void assertSourcesChanged(MockContainer container, boolean available, boolean changed,
      IResource... resources) {

    MockContext context = (MockContext) project.getContext(container);
    if (available) {
      context.assertSourcesAvailable(resources);
    } else {
      context.assertSourcesAvailable();
    }
    if (changed) {
