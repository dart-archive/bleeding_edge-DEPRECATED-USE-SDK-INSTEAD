...
class ChatServerStatus {
  ...
  String get message() {
    ...
    switch (_state) {
      case STARTING: return "Server starting"; break;
      case STARTED: return "Server listening"; break;
      case STOPPING: return "Server stopping"; break;
      case STOPPED: return "Server stopped"; break;
      case ERROR: return "Server error"; break;
    }
  }
